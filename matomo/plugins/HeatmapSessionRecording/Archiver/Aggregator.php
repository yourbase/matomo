...
class Aggregator
{
    public function findRecording($idVisit)
    {
        ...
        return $this->getDbReader()->fetchRow($query, array($idVisit, SiteHsrDao::RECORD_TYPE_SESSION));
    }
    ...
    public function findRecordings($visitIds)
    {
        ...
        return $this->getDbReader()->fetchAll($query, array(SiteHsrDao::RECORD_TYPE_SESSION));
    }

...
class MeasurableSettings extends \Piwik\Settings\Measurable\MeasurableSettings
{
    ...
    protected function configureGoogleSettings()
    {
        ...
        $this->googleNewsKeywords = $this->makeSetting('googlenewskeywords', false, FieldConfig::TYPE_BOOL,
            function (FieldConfig $field) {
    ...
    protected function configureYandexSettings()
    {
        ...
        $this->yandexAccountAndHostId = $this->makeSetting('yandexAccountAndHostId', '0', FieldConfig::TYPE_STRING,
            function (FieldConfig $field) use ($yandexClient) {

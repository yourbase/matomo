...
class API extends \Piwik\Plugin\API
{
    ...
    {
        $dataTable = $this->getDataTable(YandexArchiver::KEYWORDS_YANDEX_RECORD_NAME, $idSite, $period, $date);
        return $dataTable;
    }
    ...
    {
        $dataTable = $this->getDataTable(GoogleArchiver::KEYWORDS_GOOGLE_NEWS_RECORD_NAME, $idSite, $period, $date);
        return $dataTable;
    }
